# A-N Assessment - Programmatic-PID - 2026-04-18
...
- Evidence: `tests/test_refactored_modules.py (592 lines)`
...
- Severity: medium
- Problem: Oversized files found: src/programmatic_pid/dxf_builder.py (651 lines); tests/test_dxf_builder.py (621 lines); tests/test_refactored_modules.py (592 lines)
